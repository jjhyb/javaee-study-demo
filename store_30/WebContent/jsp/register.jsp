...
font {
 ...
 <script type="text/javascript">
 	...
 	$("#username").blur(function(){
 			...
 			/* $.post("${pageContext.request.contextPath }/user",{method:"checkName",username:value},function(result){ */
 			$.get("${pageContext.request.contextPath }/user?method=checkName&username="+value,function(result){
 				if("该用户名可以使用" == result){
					$("#sp1").html("该用户名可以使用");
					$("#sp1").css("background-color","#228B22");
					$("#sub").prop("disabled",false);
 				}else {
 					$("#sp1").html("该用户名已被占用");
 					$("#sp1").css("background-color","#FF4500");
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		<font>会员注册</font>USER REGISTER<font color="red">${check }</font>
