...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			//这种方式是在form表单上添加onSubmit="return fun1();"事件以达到阻止表单提交的方式
		/* 	function fun1(){
				if($("#quantity").val() <= 0){
			...
			//这是第二种实现阻止form表单的提交方式,onsubmit="javascript:fun2(this, event)",固定格式必须要把this和event传过来
			function fun2(obj,event){
				if($("#quantity").val() <= 0){
					confirm("亲，请填写正确的购买数量哦！");
		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/product?method=page&curPage=1&cid=${pro.cid}">${pro.category.cname}&nbsp;&nbsp;&gt;</a>
					<a href="#">${pro.pname }</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<form action="${pageContext.request.contextPath }/car" method="post" id="for_id" onsubmit="javascript:fun2(this, event)" >
						<input type="hidden" name="method" value="add2Car">
